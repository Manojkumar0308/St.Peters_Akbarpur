...
import 'package:st_peters_akbarpur_school/utils/common_methods.dart';
...
//initialization of StudentProvider class to fetch student data.
  ...
  Widget build(BuildContext context) {
    ...
    final adminSmsSummary = Provider.of<AdminSmsReport>(context);

    final adminDashboard = dashBoardProvider.adminDashBoardModel;
