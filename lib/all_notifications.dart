...
import 'notification/view/pdf_viewer.dart';
...
Widget buildCard(NotificationData notification, BuildContext context) {
  ...
  } else if (notification.title == "PDF") {
    return Padding(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (_) => PDFScreen(
                            path: 'http://${notification.content}',
                          )));
            },
            child: Container(
              width: 200,
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: const [
                    ...
                    Center(
                      child: Text(
                        'Tap to open', // Display the PDF name
                        style: TextStyle(
                            fontSize: 14,
...
class _AllNotificationsState extends State<AllNotifications> {
  ...
  // ignore: prefer_typing_uninitialized_variables
  var attendance;
  late Stream<List<NotificationData>> _notificationsStream;
...
for the selected student; otherwise, it retrieves notifications for the student
  ...
  */
  Future<void> _loadNotifications() async {
    ...
    final notifications = await _databaseHelper.getNotificationsAll(
  ...
  void initState() {
    super.initState();
    _notificationsStream = _databaseHelper.getNotificationsAllStream(
        // _pageNumber, _pageSize
        );
    ...
    if (_isLoading) {
      ...
      return userType != "Parent"
          ...
          : StreamBuilder<List<NotificationData>>(
              stream: _databaseHelper.getNotificationsAllStream(
                  // _pageNumber, _pageSize
                  ),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  final List<NotificationData> notifications = snapshot.data!;
